@extends('layouts.app')
@section('title') Detail Penjualan Gudang @endsection
@section('content')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Detail Penjualan Gudang') }}</div>
                <div class="card-body">
            ...
            <a class="btn btn-info text-white" href="{{route('warehouses.edit',
            [$sale->id])}}">Ubah</a>
        </div>
    </div>
</div>
