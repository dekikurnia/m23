        ...
        if (request()->ajax()) {
            if (!empty($request->tanggal_mulai)) {
                $purchases = DB::table('purchases')
                    ...
                    ->selectRaw('SUM((((((purchase_details.kuantitas * purchase_details.harga) * 100) / 111) * 0.11) + ((purchase_details.kuantitas * purchase_details.harga) * 100) / 111)) as total_ppn')
                    ->selectRaw('SUM((((((purchase_details.kuantitas * purchase_details.harga) * 100) / 111) * 0.11) + ((((purchase_details.kuantitas * purchase_details.harga) * 100) / 111) * 0.005) + ((purchase_details.kuantitas * purchase_details.harga) * 100) / 111)) as total_ppn_pph')
